...
@Composable
fun actionColorsPrimary() = with(MaterialTheme.colorScheme) { ActionColors(primary, onPrimary, outline) }

@Composable
fun actionColorsDanger()  = with(MaterialTheme.colorScheme) { ActionColors(error, onError, outline) }

@Composable
fun actionColorsNeutral() = with(MaterialTheme.colorScheme) { ActionColors(surface, onSurface, outline) }
